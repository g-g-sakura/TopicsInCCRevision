...
The title of [A.13 of CC v3.1 release 5 Part 1](https://www.commoncriteriaportal.org/files/ccfiles/CCPART1V3.1R5.pdf#page=83) is "Referring to other standards in a ST".
...
The first two options are readily understandable and still kept in CC:2022 Part 1 (see [B.4 of CC:2022 Part 1](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART1R1.pdf#page=132)). 
...
Here, in [D.5](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART1R1.pdf#page=159) and [B.4 of CC:2022 Part 1](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART1R1.pdf#page=132), the corresponding option c) is no longer described. 
...
In [E.3.2.2 of CC:2022 Part 2](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART2R1.pdf#page=195), "cryptographic key agreement" is mentioned as an operation of FCS_COP.1.1.
Taking into account that FCS_COP.1 has dependency of FCS_CKM.4 "cryptographic key destruction", as seen in [10.2 of CC v3.1 release 5 Part 2](https://www.commoncriteriaportal.org/files/ccfiles/CCPART2V3.1R5.pdf#page=52), 
...
However in [10.3.5 of CC:2022 Part 2](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART2R1.pdf#page=55), the dependency of FCS_CKM.4 or FCS_CKM.6 is not described.
...
Also FCS_CKM.5 has dependency of FCS_CKM.6 as seen in [10.2.9 of CC:2022 Part 2](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART2R1.pdf#page=54).
In addition, as pointed out in [E.2.2](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART2R1.pdf#page=192) and [E.2.6.1 of CC:2022 Part 2](https://www.commoncriteriaportal.org/files/ccfiles/CC2022PART2R1.pdf#page=194), cryptographic key destruction is required not only for input key, but also for output derived key within the context of FCS_CKM.5.
...
However, there was a problem that the contribution to security or added value to security is not readily apparent, as seen in [14.8.2.4](https://www.commoncriteriaportal.org/files/ccfiles/CEMV3.1R5.pdf#page=272) and [14.8.3.4 of CEM v3.1 release 5](https://www.commoncriteriaportal.org/files/ccfiles/CEMV3.1R5.pdf#page=275).
...
The description in [15.9.2.4.3](https://www.commoncriteriaportal.org/files/ccfiles/CEM2022R1.pdf#page=315) and in [15.9.3.4.3 of CEM:2022](https://www.commoncriteriaportal.org/files/ccfiles/CEM2022R1.pdf#page=318) has been revised so that above naive questions can be answered through secure development.
